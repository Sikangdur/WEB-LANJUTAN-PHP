...
<body>
    ...
    <div class="container-fluid">
        ...
        $tanggal_beli = date ('d F Y', strtotime($tanggal_beli));
        ...
        if($nama_barang == "TV") {
            $harga_total = (3000000 * $total_barang) + ($harga_courier + $asuransi);
        } else if ($nama_barang == "Refrigator") {
            $harga_total = (6000000 * $total_barang) + ($harga_courier + $asuransi);
        } else{
            $harga_total = (4000000 * $total_barang) + ($harga_courier + $asuransi);
        }
        ?>
